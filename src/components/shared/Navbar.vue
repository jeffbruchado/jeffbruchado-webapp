...
<template>
         ...
         <div class="py-4 border-b border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10 mx-4 lg:mx-0">
            <div class="relative flex items-center">
               ...
               <!-- <a class="mr-3 flex-none w-[2.0625rem] overflow-hidden md:w-auto" href="/"> -->
                  ...
                  <!-- <img src="../../assets/images/Logo-01.png" class="w-full" alt="Italian Trulli"> -->
                  <img
                     v-if="colorMode === 'dark'"
                     src="../../assets/images/logo-vector-negative.svg"
                     height="20"
                     width="300" 
                  />
                  <img
               ...
               <div class="relative hidden lg:flex items-center ml-auto">
                  <nav class="text-sm leading-6 font-semibold text-slate-700 dark:text-slate-200">
                     <ul class="flex space-x-8">
                        <li><a class="hover:text-sky-500 dark:hover:text-sky-400" href="/docs/installation">Home</a></li>
                        <li><a href="/blog" class="hover:text-sky-500 dark:hover:text-sky-400">Blog</a></li>
                        <li><a class="hover:text-sky-500 dark:hover:text-sky-400" href="/blog">About</a></li>
                     </ul>
                  </nav>
                  <div class="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
                     ...
                     <colorModeBtnVue />
                     <a href="https://github.com/jeffbruchado/" class="ml-6 block text-[#A80CE6] dark:text-[#22E68f] hover:text-[#a80ce6b9] dark:hover:text-[#22e68eee]">
                        <span class="sr-only">Jeff Bruchado on GitHub</span>
               ...
               <colorModeBtnVue class="ml-auto text-slate-500 w-8 h-8 -my-1 flex items-center justify-center lg:hidden"/>
   ...
   <div class="fixed z-50 inset-0 lg:hidden hidden" id="headlessui-dialog-22" role="dialog" aria-modal="true">
      <div class="fixed inset-0 bg-black/20 backdrop-blur-sm dark:bg-slate-900/80" id="headlessui-dialog-overlay-31" aria-hidden="true"></div>
      <div class="fixed top-4 right-4 w-full max-w-xs bg-white rounded-lg shadow-lg p-6 text-base font-semibold text-slate-900 dark:bg-slate-800 dark:text-slate-400 dark:highlight-white/5">
         <button type="button" class="absolute top-5 right-5 w-8 h-8 flex items-center justify-center text-slate-500 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300" tabindex="0">
         ...
         <ul class="space-y-6">
            <li><a class="hover:text-sky-500 dark:hover:text-sky-400" href="/docs/installation">Home</a></li>
            <li><a href="https://tailwindui.com" class="hover:text-sky-500 dark:hover:text-sky-400">Blog</a></li>
            <li><a class="hover:text-sky-500 dark:hover:text-sky-400" href="/blog">About</a></li>
            <li><a href="https://github.com/tailwindlabs/tailwindcss" class="hover:text-sky-500 dark:hover:text-sky-400">GitHub</a></li>
         </ul>
      </div>
   </div>
</template>
