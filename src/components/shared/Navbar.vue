...
<template>
  <div
    class="sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] supports-backdrop-blur:bg-white/95"
    :class="{
      ...
      >
        <div class="relative flex items-end">
          ...
          <div class="relative hidden lg:flex items-end ml-auto">
            ...
            <div
              class="transition-colors duration-500 flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800"
            >
          ...
          <colorModeBtnVue
            class="ml-auto w-8 h-8 -my-1 flex items-center justify-center lg:hidden"
          />
